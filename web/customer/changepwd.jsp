...
<%!
    ...
    public void getInput(HttpServletRequest request) {
        ...
        sessionpassword = obj.getAttribute("session_password").toString();
        sessionemailid=obj.getAttribute("session_emailid").toString();
    ...
    public void updatePassword(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            stmt = conn.prepareStatement("update customer set password=? where emailid=?");
