...
<%!
    ...
    public void getInput(HttpServletRequest request)
    {
        ...
        emailid=request.getParameter("txtusername");
    ...
    public void checkLogin(HttpServletRequest request,HttpServletResponse response)
    {
        ...
        try{
        stmt=conn.prepareStatement("select customerid from customer where emailid=? and password=?");
        ...
        if (rs.next())
        {
            customercode=rs.getInt("customerid");
            rs.close();
            stmt.clearParameters();
            close();
            ...
            obj.setAttribute("session_customerid",customercode);
