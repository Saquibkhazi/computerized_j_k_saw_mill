          ...
          <div class="span8">
            <ul class="breadcrumb">
              <li><a href="home.jsp"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
                <li><a href="#">Bill</a><i class="icon-angle-right"></i></li>
              <li><a href="#">Print</a><i class="icon-angle-right"></i></li>
        ...
        <div style="margin-left: 50px;margin-top: 55px;margin-right: 400px;">
            <table class="table table-hover">
                ...
                %>
                 ...
                 <tr><input class="btn btn-theme" type="button" value="PRINT BILL" onclick="window.print()"></tr>
        </div>
