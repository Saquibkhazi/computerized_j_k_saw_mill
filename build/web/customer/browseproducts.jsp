...
<%!
    ...
    public void getProducts() {
        try {
            ...
            stock.clear();
            pic.clear();
            stmt = conn.prepareStatement ("select frames.category,frameid,framename,framesize,"
...
<html>
    ...
    <body>
        ...
        <%
            ...
            close();
        %>
        <form method="post" action="addtocartform.jsp">
         ...
         <div style="margin-left: 40px;margin-top: 55px;margin-right: 500px;">
            ...
            <tr>
             ...
             <th> 
              ...
              <a href="addcartform.jsp?y=<%=y%>&quantity=<%=i%>&framename=<%=framename.get(i).toString()%>&amount=<%=amount.get(i).toString()%>">Add to cart</a>
         </th>
              <%}%>
            </tr>
            <%  }%>
